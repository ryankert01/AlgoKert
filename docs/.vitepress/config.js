...
const ogDescription =
  "An algorithm website, with leetcode, and with nice comments and answer";
  ...
  head: [
    [
      "link",
      {
        rel: "icon",
        type: "image/svg+xml",
        href: "https://raw.githubusercontent.com/ryankert01/AlgoKert/744b53f88fc30c037f9cd303f7809737ca15739f/docs/img/icon.svg",
      },
    ],
    ...
    sidebar: [
...

      {
        ...
        items: [
          ...
          { text: "Quick Sort", link: "/sort/quick-sort" },
...

      {
        ...
        items: [
          ...
          {
            text: "Split Array into Consecutive Subsequences",
            link: "/hash-table/659",
          },
          {
            text: "Number of Submatrices That Sum to Target",
            link: "/hash-table/1074",
          },
        ],
      },

      {
        ...
        items: [
          ...
          {
            text: "Amount of Time for Binary Tree to Be Infected",
            link: "/dfs/2385",
          },
        ],
      },
...

      {
        ...
        items: [
          {
            text: "Shortest Impossible Sequence of Rolls",
            link: "/stack/2350",
          },
        ],
      },

      {
        ...
        items: [
          ...
          {
            text: "Binary Search Tree to Greater Sum Tree",
            link: "/Tree/1038",
          },
          { text: "Trie (Prefix Tree)", link: "/Tree/trie" },
          {
            text: "Minimum Spanning Tree",
            link: "/Tree/minimum-spanning-tree",
          },
          {
            text: "Binary Tree Interative Traversal",
            link: "Tree/bt-iterative-traversal",
          },
        ],
      },
